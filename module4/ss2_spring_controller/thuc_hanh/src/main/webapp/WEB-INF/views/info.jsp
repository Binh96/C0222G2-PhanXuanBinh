...
--%>
<%@ page import="com.management_customer.service.CustomerService" %>
<%@ page import="com.management_customer.service.CustomerServiceFactory" %>
<%@ page import="com.management_customer.model.Customer" %>
<%!
