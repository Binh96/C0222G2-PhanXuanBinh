...
public class UserDAO implements IUserDAO {
    ...
    public List<User> findUser(String country) throws SQLException {
        List<User> users = new ArrayList<>();
        ...
        try{
            ...
            while(rs.next()){
                ...
                String name = rs.getString("name");
                String email = rs.getString("email");
                String countries = rs.getString("country");
                users.add(new User(id, name, email, countries));
            }
        }catch (SQLException e){
            printSQLException(e);
        }
    ...
    public List<User> sortFollowName(){
        List<User> users = new ArrayList<>();
        Connection connection = getConnection();
        try{
