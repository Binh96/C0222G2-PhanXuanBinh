        ...
        <div class="row">
            <article class="col-12">
                <form action="" method="post">
                    ...
                    <input type="text" class="form-control" name="quantity" value="${quantity}" placeholder="Số lượng">
                    <p class="text-danger">${error.get('errorQuantity')}</p>
                    <label for="">Màu sắc:</label>
                    <input type="text" class="form-control" name="color" value="${color}" placeholder="Màu sắc">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <button class="btn-light btn border-secondary" type="submit">Sửa đổi</button>
                    </div>
                </form>
            </article>
        </div>
