            ...
            <div class="bg-right col-lg-9">
                ...
                <div class="text mt-4">
                    <p class="text-dark"> Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        Amet debitis dignissimos eligendi error est, facilis laboriosam laborum magni
                        quas quisquam sint soluta. Animi atque eligendi iusto quisquam similique. Amet,
                        assumenda consequatur, corporis dolor doloribus, ea eius error ex facilis fugit
                        illum ipsa ipsum minus necessitatibus officia omnis placeat porro quam quas quisquam
                        quo reiciendis repellat veniam vero voluptas? Ab accusantium alias amet cupiditate distinctio,
                        dolores dolorum ex explicabo fugiat impedit iure laboriosam libero magni maiores nemo neque non
                        nostrum, perspiciatis porro quae quam quibusdam quidem quod recusandae rem repellat sequi similique
                        suscipit temporibus totam ullam veritatis vero vitae? Exercitationem, quidem.
                    </p>
                </div>
            </div>
        </div>
