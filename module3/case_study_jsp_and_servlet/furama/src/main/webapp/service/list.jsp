        ...
        <div class="row mt-5">
            <div class="col-lg-3">
                <ul class="sidebar-list list-group">
                    <li class="sidebar-item list-group-item"><a href="/service?action=add">New employee</a></li>
                    <li class="sidebar-item list-group-item"><a href="/service?action=list">List employee</a></li>
                </ul>
            </div>
                    ...
                    <table class="table" id="myTable">
                        ...
                        <c:forEach var="service" items="${services}">
                            <tr>
                                ...
                                <td>
                                    <c:forEach var="item" items="${typeOfRent}">
                                ...
                                <td>
                                    <c:forEach var="item" items="${typeServices}">
                                ...
                                <td>
                                    <a href="/service?action=update&id=${service.id}">Edit</a>
