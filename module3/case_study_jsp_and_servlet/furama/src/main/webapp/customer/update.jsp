            ...
            <div class="bg-right col-lg-12">
                        ...
                        <tr >
                            ...
                            <td>
                                <c:forEach var="item" items="${genders}">
                                    <c:if test="${item.id == customer.getGender()}">
                                        ${item.name}
                                    </c:if>
                                </c:forEach>
                            </td>
                            ...
                            <td colspan="2">${customer.getAddress()}</td>
                        </tr>
                        </tbody>
                    </table>
                </c:if>
                ...
                <div id="formEdit">
                    <form method="post">
                        ...
                        <input type="text" name="cmnd" class="form-control" placeholder="Chứng minh nhân dân" required>
                        ...
                        <select name="customerType">
                            <c:forEach var="item" items="${customerTypes}">
                                <option value="${item.codeTypeOfCustomer}">${item.name}</option>
                            </c:forEach>
                        </select>
                        <br>
