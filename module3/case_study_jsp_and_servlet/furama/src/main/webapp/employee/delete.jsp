            ...
            <div class="bg-right col-lg-12">
                <c:if test="${employee != null}">
                    <table class="table">
                        ...
                        <tr >
                            ...
                            <td>
                                <c:forEach var="item" items="${levels}">
                                    <c:if test="${item.codeLevel == employee.getLevel()}">
                                        ${item.name}
                                    </c:if>
                                </c:forEach>
                            </td>
                            ...
                            <td>
                                <c:forEach var="item" items="${genders}">
                                    <c:if test="${item.id == employee.getGender()}">
                                        ${item.name}
                                    </c:if>
                                </c:forEach>
                            </td>
                        ...
                        <tr>
                            <td>
                                <form method="post" action="/employee?action=delete&id=${employee.getCurrentCode()}">
